...
public class Clock extends JPanel{
	...
	protected void paintComponent(Graphics g) {
		...
		g2d.drawOval(r, r, 100, 100);
		
		g2d.setColor(Color.WHITE);
		g2d.drawLine(r+50, r+50, (int)(r+50+48*cos),(int)(r+50+48*sin));
		g2d.setColor(Color.CYAN);
		g2d.drawLine(r+50, r+50, (int)(r+50+40*mincos),(int)(r+50+40*minsin));
		g2d.setColor(Color.red);
		g2d.drawLine(r+50, r+50, (int)(r+50+30*hrcos),(int)(r+50+30*hrsin));
